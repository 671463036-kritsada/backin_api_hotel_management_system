...
const furnitureAdminRoutes = require("./routes/furniture_admin_routes");
const bookingsRoutes = require("./routes/bookings_routes");
const cartRoutes = require("./routes/cart_routes");
const extraBedRoutes = require("./routes/extra_bed_routes");
...
app.use("/api/extra-bed-types", extraBedRoutes);
